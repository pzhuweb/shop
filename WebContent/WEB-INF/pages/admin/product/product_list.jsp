...
<div id="right" style="width:693px;">
<div id="right_top01" style="height:29px">
...
<div id="right_mid">
<div id="tiao" style="height:100px;">
...
<div id="right_foot01" style="height:40px;"><s:url var="first" action="product_list" namespace="/admin/product">
